...
namespace SonicB34T5
{
    ...
    /// </summary>
    public struct NxOBB : IEquatable<NxOBB>
    {
        #region Constants
        ...
        /// </summary>
        public NxOBB(Vector3 center, Vector3 halfExtents, Quaternion orientation)
        {
            Center = center;
        ...
        /// </summary>
        public static NxOBB CreateFromBoundingBox(BoundingBox box)
        {
            Vector3 mid = (box.Min + box.Max) * 0.5f;
            Vector3 halfExtent = (box.Max - box.Min) * 0.5f;
            return new NxOBB(mid, halfExtent, Quaternion.Identity);
        }
        ...
        public NxOBB Transform(Quaternion rotation, Vector3 translation)
        {
            return new NxOBB(Vector3.Transform(Center, rotation) + translation,
                                            HalfExtent,
        ...
        /// </summary>
        /// <returns>A new bounding box, transformed relative to this one</returns>
        public NxOBB Transform(float scale, Quaternion rotation, Vector3 translation)
        {
            return new NxOBB(Vector3.Transform(Center * scale, rotation) + translation,
                                            HalfExtent * scale,
                                            Orientation * rotation);
        }
        ...
        public bool Equals(NxOBB other)
        {
        ...
        {
            if (obj != null && obj is NxOBB)
            {
                NxOBB other = (NxOBB)obj;
                return (Center == other.Center && HalfExtent == other.HalfExtent && Orientation == other.Orientation);
            }
            else
            {
        ...
        public static bool operator ==(NxOBB a, NxOBB b)
        {
            return Equals(a, b);
        }
        ...
        /// </summary>
        public static ContainmentType Contains(ref BoundingBox boxA, ref NxOBB oboxB)
        {
            ...
            return NxOBB.ContainsRelativeBox(ref boxA_halfExtent, ref oboxB.HalfExtent, ref mb);
        }
        ...
        /// </summary>
        public bool Intersects(ref NxOBB other)
        {
        ...
        /// the given other box.
        /// </summary>
        public ContainmentType Contains(ref NxOBB other)
        {
            // Build the 3x3 rotation matrix that defines the orientation of 'other' relative to this box
        ...
        /// </summary>
        public static ContainmentType Contains(BoundingFrustum frustum, ref NxOBB obox)
        {
        ...
        /// </summary>
        public static ContainmentType Contains(ref BoundingSphere sphere, ref NxOBB box)
        {
            // Transform the sphere into local box space
